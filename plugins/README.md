...
| [telemetry-fix](./telemetry-fix/) | Diagnostic tools and fixes for telemetry connection issues including DNS failures and network errors | **Commands:** `/telemetry-fix:diagnose`, `/telemetry-fix:disable` - Diagnose and resolve telemetry issues like DNS failures for monitoring services |
