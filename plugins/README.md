...
| [recall](./recall/) | Recover conversation context when Claude loses track, with interactive browsing and observability logging | **Command:** `/recall` - Interactive context recovery with search, time navigation, and pagination<br>**Hook:** UserPromptSubmit - Incrementally indexes conversation exchanges |
